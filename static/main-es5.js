  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_div_1_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", ctx_r0.err.message, " ");
      }
    }
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(fb, http) {
        ...
        this.http = http;
        this.title = 'frontend';
        this.url = 'https://store-recommender.wn.r.appspot.com/';
        this.groceryList = '';
        this.err = {
          isErr: false,
          message: ""
        ...
        value: function onSubmit() {
          ...
          if (navigator.geolocation) {
            ...
            navigator.geolocation.getCurrentPosition(function (location) {
              ...
              _this.http.post(_this.url, body).subscribe(function (optimal) {
                if (optimal) {
                  _this.optimalStore = optimal;
                } else {
                  _this.err = {
                    isErr: true,
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 2,
      consts: [[4, "ngIf"], [1, "example-form", 3, "ngSubmit"], [1, "example-full-width"], ["matInput", "", "placeholder", "milk,bread,detergent", "name", "groceryList", 3, "ngModel", "ngModelChange"], ["type", "submit"]],
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, " Please enter your grocery list as a list of comma separated values ");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "form", 1);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AppComponent_Template_form_ngSubmit_4_listener() {
            return ctx.onSubmit();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "grocery list");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "textarea", 3);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_textarea_ngModelChange_8_listener($event) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.err.isErr);
